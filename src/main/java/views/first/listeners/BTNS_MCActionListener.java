...
public class BTNS_MCActionListener implements ActionListener {
      ...
      private void delOp(String table) {
            ...
            System.out.println("##1# TEST TF_2 TEXT: " + VF_R.getJTFES()[1].getText());
            System.out.println("##1# TEST TF_3 TEXT: " + VF_R.getJTFES()[2].getText());
            DT.bool_Del = true;
            //System.out.println("\nDELETING DATA");
            ...
            //ms.deleteRow_TEST(table, cols, values);
            ms.deleteRow(table, cols, values, new DeleteRow(values));
            System.out.println("##2# TEST TF_1 TEXT: " + VF_R.getJTFS()[0].getText());
            System.out.println("##2# TEST TF_2 TEXT: " + VF_R.getJTFES()[1].getText());
            System.out.println("##2# TEST TF_3 TEXT: " + VF_R.getJTFES()[2].getText());
            ...
            System.out.println("##3# TEST TF_2 TEXT: " + VF_R.getJTFES()[1].getText());
            System.out.println("##3# TEST TF_3 TEXT: " + VF_R.getJTFES()[2].getText());
            DISTS.start(false, false);

            //sc_JT.getVerticalScrollBar().setValue(sc_JT.getVerticalScrollBar().getMaximum());
            DT.bool_Del = false;
            System.out.println(CC.GREEN + "\nDELETE DATA ENDS " + CC.RESET);
            System.out.println("##4# TEST TF_1 TEXT: " + VF_R.getJTFS()[0].getText());
            System.out.println("##4# TEST TF_2 TEXT: " + VF_R.getJTFES()[1].getText());
            System.out.println("##4# TEST TF_3 TEXT: " + VF_R.getJTFES()[2].getText());
      }
