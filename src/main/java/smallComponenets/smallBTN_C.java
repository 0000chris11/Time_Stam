      ...
      public void paintComponent(Graphics g) {
            ...
            if (getModel().isEnabled()) {
                  if (getModel().isPressed()) {
                        ...
                        g2.setPaint(new GradientPaint(0, 0, LKCustom.GP_WHITE_AND_CYAN[0],
                                w, h, LKCustom.GP_WHITE_AND_CYAN[1].darker()));
                  } else {
                        //System.out.println("\tNORMAL");
                        g2.setPaint(new GradientPaint(0, 0, LKCustom.GP_WHITE_AND_CYAN[0],
                                w, h, LKCustom.GP_WHITE_AND_CYAN[1]));
                  }
            } else {
                  g2.setPaint(new GradientPaint(0, 0, LKCustom.GP_WHITE_AND_CYAN[0].darker(),
                          w, h, LKCustom.GP_WHITE_AND_CYAN[1].darker()));
            }
            g2.fillRect(0, 0, w, h);
